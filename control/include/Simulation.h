...
std::vector<Eigen::VectorXd> KalmanFilter(const std::vector<Eigen::VectorXd> &groundTruth, const float &disturbance, const LinearSystems::StateSpace &sys, const Eigen::VectorXd &x0, const Eigen::MatrixXd &P0);
